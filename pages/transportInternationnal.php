...
<body>
	...
	============================================= -->
    <section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="../assets/img/bg/v-bg.jpg">
    ...
    <section id="ft-service-page" class="ft-service-page-section page-padding">
        <div class="container text-center text-body">
            <p>Nous assurons le transport international de vos marchandises et équipements à destination du continent Africain.
                Pour ce faire nous nous appuyons sur nos bases logistiques à Dakar, Paris, New York et Guangzhou, ainsi que sur un réseau de Partenaires au sein de la CEDEAO.</p>
        </div>
        <div class="container">
            <div class="ft-section-title-2 headline pera-content text-center mt-10">
                <span class="sub-title">Nos services de transport international</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                <h3><a href="#">Maritime</a></h3>
                                <div class="ft-btn-2 text-white">
                                Transport International par voie maritime : Groupage ou Conteneur complet. Service de pré-acheminement au départ, post-acheminement à l’arrivée, et gestion des démarches en douane.
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                <h3><a href="#">Aérien</a></h3>
                                <div class="ft-btn-2 text-white">
                                   <p>Transport international de vos colis et palettes par fret aérien : fret express ou fret standard ou groupage aérien. Possibilité de transporter des produits périssables ou des produits réglementés.</p>
                                </div>
                            </div>
                            <div class="ft-service-serial position-absolute">
                                2
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                <h3><a href="#">Services Annexes</a></h3>
                                <div class="ft-btn-2 text-white">
                                Solutions sur mesure. Prise en charge d’envois volumineux ou très lourds (véhicules, matériels industriels, …). Expéditions internationales multi-destinations en Afrique de l’Ouest.</div>
                            </div>
                            <div class="ft-service-serial position-absolute">
                                3
                            </div>
