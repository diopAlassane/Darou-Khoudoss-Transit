...
<body>
                                ...
                                <ul id="ft-main-nav" class="nav navbar-nav clearfix">
                                    ...
                                    <li class="dropdown">
										...
										<ul class="dropdown-menu clearfix">
											...
											<li><a href="#">Vente de voiture</a></li>
										</ul>
									</li>
    ...
    <section id="ft-service-page" class="ft-service-page-section page-padding">
        <div class="container text-center text-body">
            <p>Avec un entrepôt sous douane à Dakar, des équipes qualifiées et une flotte de véhicules, nous assurons votre logistique au Sénégal et en Afrique de l’Ouest.</div>
        <div class="container">
            <div class="ft-section-title-2 headline pera-content text-center mt-10">
                <span class="sub-title">Nos services logistiques</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                Stockage de vos marchandises à Dakar dans un entrepôt sécurisé de 500m2. </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                <h3><a href="#">Préparation Commandes</a></h3>
                                <div class="ft-btn-2 text-white">
                                Emballage, manutention, étiquetage, et suivi informatisé. Nous effectuons la préparation de vos commandes selon vos instructions et nous vous donnons accès à un compte rendu en ligne.</div>
                            </div>
                            <div class="ft-service-serial position-absolute">
                                2
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ft-service-innerbox-2 position-relative">
                            ...
                            <div class="ft-service-text position-relative headline">
                                ...
                                <h3><a href="#">Dernier KM</a></h3>
                                <div class="ft-btn-2 text-white">
                                Transport routier pour la livraison des produits jusque dans vos locaux ou chez vos clients finaux.</div>
                            <div class="ft-service-serial position-absolute">
                                3
                            </div>
                        </div>
