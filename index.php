...
<body>
								...
								<ul id="ft-main-nav" class="nav navbar-nav clearfix">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu clearfix">
											<li><a href="pages/transportInternationnal.php">Transport Internationnal</a></li>
											<li><a href="pages/logistique.php">Logistique</a></li>
											<li><a href="pages/prestationSpeciale.php">Prestation spéciale</a></li>
										</ul>
									</li> 
									<li class="dropdown">
										<a href="#">Transport</a>
										<ul class="dropdown-menu clearfix">
											<li><a href="./pages/locationVehicule.php">Location de voiture</a></li>
											<li><a href="./pages/venteVehicule.php">Vente de voiture</a></li>
										</ul>
									</li>
									<li><a href="pages/cotationFret.php">Cotation de fret</a></li>
									<li><a href="pages/contact.php">Contact</a></li>
								</ul>
							</nav>
							<div class="ft-header-cta-btn">
								<a class="d-flex justify-content-center align-items-center" href="./pages/contact.php">Devis
									gratuit</a>
							</div>
						</div>
					</div>
						...
						<div class="mobile_menu_wrap">
							...
							<div class="mobile_menu_content">
								...
								<div class="m-brand-logo">
									<a href="!#"><img src="assets/newImgs/logo.png" alt="" style="width: 150px; height: 150px;"></a>
								</div>
								<nav class="mobile-main-navigation  clearfix ul-li">
									...
									<li><a href="index.php">Accueil</a></li>
										<li class="dropdown">
											...
											<ul class="dropdown-menu clearfix">
												<li><a href="pages/transportInternationnal.php">Transport Internationnal </a></li>
												<li><a href="pages/transportInternationnal.php"> Logistique</a></li>
												<li><a href="pages/prestationSpeciale.php"> Prestation spéciale</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="#">Transport</a>
											<ul class="dropdown-menu clearfix">
												<li><a href="#">Location de véhicule </a></li>
												<li><a href="#"> Vente de véhicule</a></li>
											</ul>
										</li>
										<li><a href="pages/cotationFret.php.php">Cotation de frais</a></li>
										<li><a href="pages/contact.php.php">Contact</a></li>
									</ul>
								</nav>
							</div>
						</div>
			...
			<rs-slides>
				<rs-slide style="position: absolute;" data-key="rs-70" data-title="Slide"
					...
					<rs-layer id="slider-27-slide-70-layer-1" data-type="text" data-rsp_ch="on"
						...
						style="z-index:9;font-family:'Poppins';">Nous sommes un fournisseur<br />
						Logistique mondiale
					</rs-layer>
					...
					<a id="slider-27-slide-70-layer-5" class="rs-layer rev-btn" href="./pages/contact.php" target="_blank"
						...
						style="z-index:12;background-color:#00044b;font-family:'Poppins';">A propos de nous
					</a>
					<a id="slider-27-slide-70-layer-6" class="rs-layer rev-btn" href="./pages/logistique.php" target="_blank"
						rel="noopener" data-type="button" data-rsp_ch="on"
						...
						data-frame_hover="bgc:#ea1e00;boc:#ea1e00;bor:3px,3px,3px,3px;bos:solid;bow:2px,2px,2px,2px;sp:100;e:power1.inOut;bri:120%;"
						style="z-index:11;background-color:#00044b;font-family:'Poppins';">Nos Services
					</a>
				</rs-slide>
				<rs-slide style="position: absolute;" data-key="rs-72" data-title="Slide"
					...
					<a id="slider-27-slide-72-layer-5" class="rs-layer rev-btn" href="./pages/contact.php" target="_blank"
						rel="noopener" data-type="button" data-rsp_ch="on"
						data-xy="xo:235px,194px,147px,138px;yo:620px,512px,389px,275px;"
						data-text="w:normal;s:18,14,10,14;l:52,42,31,40;fw:500;a:center;"
						data-dim="w:200px,165px,125px,120px;h:55px,45px,34px,45px;minh:0px,none,none,none;"
					...
					<a id="slider-27-slide-72-layer-6" class="rs-layer rev-btn" href="./pages/logistique.php" target="_blank"
						rel="noopener" data-type="button" data-rsp_ch="on"
						data-xy="xo:15px,12px,9px,5px;yo:620px,512px,389px,274px;"
						data-text="w:normal;s:18,14,10,14;l:52,42,31,40;fw:500;a:center;"
						data-dim="w:200px,165px,125px,120px;h:55px,45px,34px,45px;minh:0px,none,none,none;"
				...
				<rs-slide style="position: absolute;" data-key="rs-73" data-title="Slide"
					...
					<a id="slider-27-slide-73-layer-5" class="rs-layer rev-btn" href="./pages/contact.php" target="_blank"
						rel="noopener" data-type="button" data-rsp_ch="on"
						data-xy="xo:235px,194px,147px,138px;yo:620px,512px,389px,275px;"
						data-text="w:normal;s:18,14,10,14;l:52,42,31,40;fw:500;a:center;"
						data-dim="w:200px,165px,125px,120px;h:55px,45px,34px,45px;minh:0px,none,none,none;"
					...
					<a id="slider-27-slide-73-layer-6" class="rs-layer rev-btn" href="./pages/logistique.php" target="_blank"
						rel="noopener" data-type="button" data-rsp_ch="on"
						data-xy="xo:15px,12px,9px,5px;yo:620px,512px,389px,274px;"
						data-text="w:normal;s:18,14,10,14;l:52,42,31,40;fw:500;a:center;"
						data-dim="w:200px,165px,125px,120px;h:55px,45px,34px,45px;minh:0px,none,none,none;"
	...
	============================================= -->
	<section id="ft-booking-form" class="ft-booking-form-section text-center">
		<div class="container">
				...
				<form action="#">
					<div class="booking-form-input-wrapper d-flex flex-wrap">
						<label class="booking-form-input position-relative">
							<span class="booking-form-icon"><i class="fa fa-face-eyes"></i></span>
							<input type="text" placeholder="Votre ID de suivi maintant">
						</label>
						<label class="booking-form-input position-relative">
							<span class="booking-form-icon"><i class="fa fa-envelope"></i></span>
							<input type="text" placeholder="Votre adresse  email">
						</label>
						<button class="ft-sb-button" type="submit">Suivre la commande maintenant</button>
					</div>
				</form>
			</div>
		</div>
						...
						<div class="ft-about-img-exp position-relative">
							<div class="ft-about-exp-area headline pera-content position-absolute">
								...
								<div class="ft-about-exp-text position-absolute">
									<h3><span class="counter">25</span><b>+</b> ans</h3>
									<p>Nos avons plus d'années d'expérience
									</p>
								</div>
							</div>
					...
					<div class="col-lg-6">
						<div class="ft-about-text-wrapper">
							<div class="ft-section-title headline pera-content">
								<span class="sub-title">A propos de la société</span>
								<h2>Entreprise de logistique de transport numérique et de confiance
								</h2>
							...
							<div class="ft-about-feature-list-warpper">
								<div class="ft-about-feature-list-item d-flex align-items-center wow fadeInUp"
									...
									<div class="ft-about-feature-text headline pera-content">
										...
										<p>Nous fournissons toujours aux gens une solution complète axée sur toute
											entreprise.
										</p>
									</div>
								</div>
								...
								<div class="ft-btn wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
									<a class="d-flex justify-content-center align-items-center"
										href="about.html">Explorer plus</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="ft-service-text-area">
							<div class="ft-section-title headline pera-content">
								...
								<h2>Nous sommes des optimistes qui aimons travailler ensemble.
								</h2>
							</div>
							<div class="ft-btn">
								<a class="d-flex justify-content-center align-items-center" href="./pages/logistique.php">Plus de
									Services</a>
							</div>
						</div>
					</div>
							...
							<div class="ft-service-slider-wrapper">
								<div class="ft-item-innerbox wow fadeInLeft" data-wow-delay="200ms"
									...
									<div class="ft-service-slider-item">
										...
										<div class="ft-service-inner-text headline pera-content position-relative">
											<h3><a href="service-single.html">Fret aérien</a></h3>
											<p>Do eiusmod tempor incididunt ut labore et dolore magna </p>
											<a class="service-more"
												href="service-single.html">Commencer<span>+</span></a>
								...
								<div class="ft-item-innerbox wow fadeInLeft" data-wow-delay="400ms"
									...
									<div class="ft-service-slider-item">
										...
										<div class="ft-service-inner-text headline pera-content position-relative">
											<h3><a href="service-single.html">Fret maritime</a></h3>
											<p>Do eiusmod tempor incididunt ut labore et dolore magna </p>
											<a class="service-more" href="service-single.html">Commencer
												<span>+</span></a>
											<div class="ft-service-serial position-absolute">
												2
											</div>
								...
								<div class="ft-item-innerbox wow fadeInLeft" data-wow-delay="600ms"
									...
									<div class="ft-service-slider-item">
										...
										<div class="ft-service-inner-text headline pera-content position-relative">
											<h3><a href="service-single.html">Fret routier</a></h3>
											<p>Do eiusmod tempor incididunt ut labore et dolore magna </p>
											<a class="service-more" href="service-single.html">Commencer
												<span>+</span></a>
											<div class="ft-service-serial position-absolute">
					...
					<div class="col-lg-7">
						<div class="ft-why-choose-text-area">
							<div class="ft-section-title headline pera-content wow fadeInUp" data-wow-delay="0ms"
								...
								<h2>Notre objectif est de bien contribuer à votre entreprise
								</h2>
							</div>
							<div class="ft-why-choose-feature-wrapper">
								<div class="ft-why-choose-feature-item d-flex align-items-center wow fadeInUp"
									...
									<div class="ft-why-choose-feature-text headline pera-content">
										<h3>Service de transport rapide</h3>
								...
								<div class="ft-why-choose-feature-item d-flex align-items-center wow fadeInUp"
									...
									<div class="ft-why-choose-feature-text headline pera-content">
										<h3>Expédition dans le monde entier</h3>
										<p>Dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor labore et
											dolore magna aliqua.</p>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
						<div class="ft-team-text-area">
							<div class="ft-section-title headline pera-content">
								...
								<h2>Notre membre expert de l'équipe
								</h2>
								<p>aliqua. Quis ipsum suspendisse viverra maecenas accumsan lacus vel facilisis. </p>
							</div>
							<!-- <div class="ft-btn">
								<a class="d-flex justify-content-center align-items-center" href="team.html">Explorer l'équipe</a>
							</div> -->
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="ft-team-inner-itembox position-relative">
							...
							<div class="ft-team-inner-item-text headline">
								<h3><a href="team-single.html">Khady DIENG</a></h3>
								<span>Gestionnaire d'envoie</span>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="ft-team-inner-itembox position-relative">
							...
							<div class="ft-team-inner-item-text headline">
								<h3><a href="team-single.html">Fatou DIOP</a></h3>
								<span>Gestionnaire d'envoie</span>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="ft-team-inner-itembox position-relative">
							...
							<div class="ft-team-inner-item-text headline">
								<h3><a href="team-single.html">Lamine GUEYE</a></h3>
								<span>Gestionnaire d'envoie</span>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="ft-project-content d-flex justify-content-between align-items-end flex-wrap">
				<div class="ft-section-title headline pera-content">
					...
					<h2>Découvrons notre tout dernier projet
					</h2>
				</div>
				<!-- <div class="ft-btn">
					<a class="d-flex justify-content-center align-items-center" href="project.html">Tous Projets</a>
				</div> -->
			</div>
		</div>
			...
			<div class="ft-project-slider-area">
				<div class="ft-item-innerbox">
					<div class="ft-project-itembox position-relative">
						...
						<div class="ft-project-text headline pera-content">
							<h3><a href="portfolio-single.html">Transport industrielle et arérien </a></h3>
				...
				<div class="ft-item-innerbox">
					<div class="ft-project-itembox position-relative">
						...
						<div class="ft-project-text headline pera-content">
							<h3><a href="portfolio-single.html">Transport industrielle et maritime </a></h3>
							<p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus
								vel facilisis. </p>
							<!-- <div class="ft-btn">
								<a class="d-flex justify-content-center align-items-center" href="project-single.html">Explore More</a>
				...
				<div class="ft-item-innerbox">
					<div class="ft-project-itembox position-relative">
						...
						<div class="ft-project-text headline pera-content">
							<h3><a href="portfolio-single.html">Transport industrielle et routier </a></h3>
							<p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus
								vel facilisis. </p>
							<!-- <div class="ft-btn">
								<a class="d-flex justify-content-center align-items-center" href="project-single.html">Explore More</a>
	...
	<section id="ft-testimonial" class="ft-testimonial-section position-relative">
		...
		<div class="container">
			<div class="ft-section-title headline pera-content text-center">
				...
				<h2>Que pensent les gens et les clients de nous ?
				</h2>
			</div>
					...
					<div class="ft-item-innerbox wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="ft-testimonial-item-innerbox">
							...
							<div class="ft-testimonial-text-item text-center">
								Lorem ipsum dolor sit amet, consectetur gravida. Risus commodo viverra maecenas accumsan
								lacus vel facilisis.
							</div>
	...
	<section id="ft-contact" class="ft-contact-section position-relative" data-background="assets/img/bg/c-bg.jpg">
		<div class="container">
			<div class="ft-contact-content">
				<div class="ft-section-title headline pera-content">
					<span class="sub-title">Estimation du projet</span>
					<h2>Demander un devis rapide
					</h2>
				...
				<div class="ft-contact-form-wrapper">
					<form action="#">
						<div class="row">
							...
							<div class="col-md-12">
								<button class="ft-sb-button">Soumettre</button>
							</div>
						</div>
					</form>
				</div>
		...
		<div class="container">
			<div class="ft-blog-top-content d-flex justify-content-between align-items-end flex-wrap">
				<div class="ft-section-title headline pera-content">
					...
					<h2>Découvrons toutes nos dernières nouvelles
					</h2>
				</div>
				<div class="ft-btn">
					<a class="d-flex justify-content-center align-items-center" href="#">Plus d'infos</a>
				</div>
			</div>
				...
				<div class="row">
								...
								<div class="ft-blog-feed-text headline pera-content">
									<div class="ft-blog-meta d-flex justify-content-between flex-wrap">
										<div class="ft-blog-data">
											<a href="#"><i class="far fa-calendar-alt"></i> 28 août, 2022</a>
										</div>
									...
									<h3><a href="blog-single.html">Comment saurez-vous le succés quand il
											apparaîtra?</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
										incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
										gravida. Risus commodo facilisis. </p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="ft-blog-feed-wrapper-2">
							<div class="ft-blog-news-feed-innerbox wow fadeInUp" data-wow-delay="200ms"
								data-wow-duration="1500ms">
								<div class="ft-blog-feed-img">
								...
								<div class="ft-blog-feed-text headline pera-content">
									<div class="ft-blog-meta d-flex justify-content-between flex-wrap">
										<div class="ft-blog-data">
											<a href="#"><i class="far fa-calendar-alt"></i> 29 août, 2021</a>
										</div>
										<div class="ft-blog-comment-view">
											<a href="#"><i class="far fa-comments"></i> 70</a>
											<a href="#"><i class="far fa-eye"></i> 250</a>
										</div>
									</div>
									<h3><a href="#">Comment saurez-vous le succés quand il
											apparaîtra?</a></h3>
									<p>Tempor incididunt ut labore et dolore magna aliqua. ultrices gravida. </p>
								</div>
							</div>
							<div class="ft-blog-news-feed-innerbox wow fadeInUp" data-wow-delay="400ms"
								data-wow-duration="1500ms">
								<div class="ft-blog-feed-img">
								...
								<div class="ft-blog-feed-text headline pera-content">
									<div class="ft-blog-meta d-flex justify-content-between flex-wrap">
										<div class="ft-blog-data">
											<a href="#"><i class="far fa-calendar-alt"></i> 28 Aug, 2022</a>
										</div>
										<div class="ft-blog-comment-view">
											<a href="#"><i class="far fa-comments"></i> 80</a>
											<a href="#"><i class="far fa-eye"></i> 300</a>
							...
							<div class="ft-blog-news-feed-innerbox wow fadeInUp" data-wow-delay="600ms"
								data-wow-duration="1500ms">
								<div class="ft-blog-feed-img">
								...
								<div class="ft-blog-feed-text headline pera-content">
									<div class="ft-blog-meta d-flex justify-content-between flex-wrap">
										<div class="ft-blog-data">
											<a href="#"><i class="far fa-calendar-alt"></i> 30 août, 2022</a>
										</div>
										<div class="ft-blog-comment-view">
											<a href="#"><i class="far fa-comments"></i> 80</a>
											<a href="#"><i class="far fa-eye"></i> 300</a>
					...
					<div class="col-lg-3 col-md-6">
						<div class="ft-footer-widget ul-li-block headline pera-content">
							<div class="logo-widget">
								<div class="site-logo">
									<!-- <a href="./index.php"><img src="assets/newImgs/logo.png" alt=""></a> -->
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
									incididunt ut labore et dolore magna aliqua. </p>
								<div class="ft-btn">
									<a class="d-flex justify-content-center align-items-center"
										href="pages/contact.php">Entrer en contact</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="ft-footer-widget ul-li-block headline pera-content">
							<div class="gallery-widget clearfix">
								<h3 class="widget-title">Gallerie </h3>
